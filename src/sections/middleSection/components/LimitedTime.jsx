  ...
  return (
    <div className="flex flex-col w-full items-center     ">
      ...
      <div className="flex justify-between w-full max-w-[1200px] px-6 mt-9 gap-6">
        <div className="flex-1 border shadow-lg hover:shadow-2xl overflow-hidden group max-h-[320px] transition-all duration-300 ease-in-out hover:max-h-[600px]">
          <div className="flex flex-col">
            ...
            <div className="relative text-black flex w-full justify-between border-b p-2 items-center opacity-40 group-hover:opacity-100">
              <div className="flex gap-2 items-center">
                <img
                  src={Fiverr}
                  alt="javascript"
              ...
              <div className="absolute bottom-0 left-1/2 group-hover:opacity-0">
        ...
        <div className="flex-1 border shadow-lg hover:shadow-2xl overflow-hidden group max-h-[320px] transition-all duration-300 ease-in-out hover:max-h-[600px]">
          <div className="flex flex-col">
            ...
            <div className="relative text-black flex w-full justify-between mt-2 border-b p-2 items-center opacity-40 group-hover:opacity-100">
              <div className="flex gap-2 items-center">
